...
function dashboardSidebar(){
	...
	<ul>
		 <li <?php echo $activeClass; ?>><a href="<?php echo site_url(); ?>/account/"><i class="fa fa-window-maximize"></i> Dashboard</a></li>
		 <li <?php echo $activeClass; ?>><a href="<?php echo site_url(); ?>/idealist/"><i class="fa fa-window-maximize"></i> Ideas</a></li>
